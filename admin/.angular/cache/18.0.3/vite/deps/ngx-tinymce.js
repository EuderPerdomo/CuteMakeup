...
_NuLazyService.ɵfac = function NuLazyService_Factory(t) {
  return new (t || _NuLazyService)(ɵɵinject(DOCUMENT));
};
...
_TinymceComponent.ɵfac = function TinymceComponent_Factory(t) {
  return new (t || _TinymceComponent)(ɵɵdirectiveInject(TinymceOptions, 8), ɵɵdirectiveInject(NuLazyService), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(ChangeDetectorRef));
};
...
_NgxTinymceModule.ɵfac = function NgxTinymceModule_Factory(t) {
  return new (t || _NgxTinymceModule)();
};
